...
1.  Navigera till fliken **Overview**.
    ...
    ![Overview](../../assets/standard/images/chap09/bild1.png)

2.  Leta upp sektionen **Triggers** och klicka på **+ Add trigger**.

    ![Add Trigger](../../assets/standard/images/chap09/bild2.png)
...
3.  Sök efter 
    ...
    ![Search Trigger](../../assets/standard/images/chap09/bild3.png)

4.  Välj **When an item is created (SharePoint)** och klicka **Next**.

    ![Select Trigger](../../assets/standard/images/chap09/bild4.png)

5.  Vänta tills anslutningen konfigureras och klicka sedan på **Next**.

    ![Configure Connection](../../assets/standard/images/chap09/bild5.png)
...
6.  **Konfigurera Triggern:**
    * **Site Address:** Klicka på dropdown-menyn och välj **IT Support**. (Om du inte ser den, klicka på *Enter custom value* och klistra in URL:en, eller sök).
    ...
    ![Select Site](../../assets/standard/images/chap09/bild6.png)

    * **List Name:** Välj **Tickets**.

    ![Select List](../../assets/standard/images/chap09/bild7.png)
...
8.  Klicka på **Create trigger**.
    ...
    ![Create Trigger](../../assets/standard/images/chap09/bild8.png)
...
2.  Välj **Edit in Power Automate**.
    ...
    ![Edit in Power Automate](../../assets/standard/images/chap09/bild9.png)
...
3.  Du ser två noder. Klicka på den nedre noden: **Send a prompt to the specified copilot for processing**.
    ...
    ![Open Node](../../assets/standard/images/chap09/bild10.png)
...
4.  **Redigera meddelandet:**
    ...
    * Skriv ett snedstreck `/` och välj **Insert Expression** (fx-ikonen).
    ...
    ![Insert Expression](../../assets/standard/images/chap09/bild11.png)
...
5.  **Lägg till uttrycket:**
    ...
    * Klicka på **Add**.
    ...
    ![Insert Expression](../../assets/standard/images/chap09/bild12.png)
...
6.  Klicka på **Save** högst upp till höger på sidan.
    ...
    ![Save Flow](../../assets/standard/images/chap09/bild13.png)
...
1.  Navigera till fliken **Topics** (eller Tools) och välj **+ Add a tool**.
    ...
    ![Add Tool](../../assets/standard/images/chap09/bild14.png)
...
2.  Sök efter 
    ...
    ![Search Email](../../assets/standard/images/chap09/bild15.png)

3.  Välj **Send an email (V2)** (Office 365 Outlook).

    ![Select Email V2](../../assets/standard/images/chap09/bild16.png)
...
4.  Vänta på anslutningen genom att konntrolera att det är grönt tillhöger om den mejladress och klicka sedan på **Add and configure** (eller Next).
    ...
    ![Add and Configure](../../assets/standard/images/chap09/bild17.png)
...
5.  **Konfigurera verktyget:**
    ...
    * **Description:**
    ...
    ![Configure Tool](../../assets/standard/images/chap09/bild18.png)
...
6.  **Konfigurera Inputs (Viktigt):**
    ...
    * Klicka på dropdown-menyn där det står *Dynamically fill with AI* och välj **Custom value**.
    ...
    ![Configure To Input](../../assets/standard/images/chap09/tool-config-to-custom.png)

    * Skriv in din egen e-postadress i fältet (t.ex. `JoelThyberg@thybergai.onmicrosoft.com`).

    ![Configure To Input](../../assets/standard/images/chap09/bild19.png)
    ...
    * Klicka på **Customize** bredvid Subject.
    ...
    ![Configure Subject](../../assets/standard/images/chap09/tool-config-subject-edit.png)
    ...
    * Se till att **Identify as** är satt till *User's entire response*.
    ...
    ![Configure Subject Details](../../assets/standard/images/chap09/bild20.png)
    ...
    * Klicka på **Customize**.
    ...
    ![Configure Body](../../assets/standard/images/chap09/bild21.png)
    ...
    * Se till att **Identify as** är satt till *User's entire response*.
    ...
    ![Configure Body Details](../../assets/standard/images/chap09/bild22.png)

...
![Hitta Lösningar i menyn](../../assets/standard/images-sv/chap03/1.png)

3. Nu ser du en lista på alla lösningar i miljön. Klicka på **+ Ny lösning**.

![Klicka på Ny lösning](../../assets/standard/images-sv/chap03/2.png)
...
![Skapa ny utgivare](../../assets/standard/images-sv/chap03/3.png)
...
![Spara utgivare](../../assets/standard/images-sv/chap03/4.png)
...
![Fyll i lösningsdetaljer](../../assets/standard/images-sv/chap03/5.png)
...
![Gå tillbaka till översikten](../../assets/standard/images-sv/chap03/6.png)

2. Titta högst upp på sidan. Du ska nu se en ruta där det står **Aktuell föredragen lösning: IT Helpdesk Agent**.

![Verifiera föredragen lösning-banner](../../assets/standard/images-sv/chap03/7.png)

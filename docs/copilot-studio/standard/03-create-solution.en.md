...
![Hitta Solutions i menyn](../../assets/standard/images/chap03/sol-menu-find.png)

3. Nu ser du en lista på alla lösningar i miljön. Klicka på **+ New solution**.

![Klicka på New solution](../../assets/standard/images/chap03/sol-new-button.png)
...
![Skapa ny publisher](../../assets/standard/images/chap03/sol-new-publisher.png)
...
![Spara publisher](../../assets/standard/images/chap03/sol-publisher-save.png)
...
![Fyll i solution detaljer](../../assets/standard/images/chap03/sol-create-details.png)
...
![Gå tillbaka till översikten](../../assets/standard/images/chap03/sol-verify-back.png)

2. Titta högst upp på sidan. Du ska nu se en ruta där det står **Current preferred solution: IT Helpdesk Agent**.

![Verifiera preferred solution banner](../../assets/standard/images/chap03/sol-verify-banner.png)

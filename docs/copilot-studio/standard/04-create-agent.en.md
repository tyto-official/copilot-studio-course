...
??? info "Alternativ väg: Skapa direkt inifrån din Solution (Klicka för att se)"
    ...
    **1. Gå in i din Solution**
    ...
    ![Lista med solutions](../../assets/standard/images/chap04/create-sol-list.png)

    **2. Klicka på New**
    Väl inne i lösningen ser du allt som ingår i den. Klicka på **+ New** i toppmenyn.
    
    ![Inne i solution](../../assets/standard/images/chap04/create-sol-inside.png)

    **3. Välj Agent**
    I menyn som fälls ut, välj **Agent** -> **Agent**.
    
    ![Menyval för att skapa agent](../../assets/standard/images/chap04/create-sol-menu.png)
    ...
    **4. Förhandsvisning och Val**
    ...
    ![Preview av create agent](../../assets/standard/images/chap04/create-sol-preview.png)
    ...
    ![Configure fliken](../../assets/standard/images/chap04/create-sol-create.png)
...
3. Klicka på **+ Create blank agent** (uppe i högra hörnet).
    ...
    ![Klicka på Create blank agent](../../assets/standard/images/chap04/create-agent-button.png)
...
![Översikt av agenten](../../assets/standard/images/chap04/create-overview.png)
...
![Agenten hälsar](../../assets/standard/images/chap04/test-greeting.png)
...
![Agenten vet inte svaret](../../assets/standard/images/chap04/test-fail.png)

...
1.  Navigera till dina **Topics** i Copilot Studio.
    ...
    ![Navigera till Topics](../../assets/standard/images/chap07/topic-navigate.png)

2.  Välj **+ Add a topic** -> **From blank**.

    ![Välj Add a topic](../../assets/standard/images/chap07/topic-add-a-topic.png)
...
3.  Döp topicen till:
    ...
    ![Skapa topic](../../assets/standard/images/chap07/topic-create-request.png)
...
3.  I rutan **Description** (under Trigger), klistra in följande svenska beskrivning:
    ...
    ![Beskrivning](../../assets/standard/images/chap07/topic-description.png)
...
2.  Välj **Ask with Adaptive Card**.
    ...
    ![Välj Adaptive Card](../../assets/standard/images/chap07/topic-add-adaptive-card.png)

3.  Klicka på de tre prickarna på kort-noden och välj **Properties**.

    ![Kort Properties](../../assets/standard/images/chap07/card-properties.png)

4.  I panelen till höger, klicka på knappen **Edit Adaptive Card**.

    ![Redigera kort](../../assets/standard/images/chap07/card-edit-button.png)
...
![Editor](../../assets/standard/images/chap07/card-designer.png)

1.  Prova att dra in ett **TextBlock** från vänstermenyn till kortet.

    ![Dra in text](../../assets/standard/images/chap07/card-drag-text.png)

2.  Ändra texten till "Tillgängliga enheter" i menyn till höger.

    ![Text](../../assets/standard/images/chap07/card-text.png)

3.  Ändra **Horizontal alignment** till **Center**.

    ![Horizontal alignment](../../assets/standard/images/chap07/card-horizontal-alignment.png)

4.  Prova att dra in en **Input.ChoiceSet** under texten.

    ![Dra in val](../../assets/standard/images/chap07/card-drag-choice.png)

5.  Ändra **Style** till **Expanded** för att se hur det ser ut som en lista med radioknappar.

    ![Style](../../assets/standard/images/chap07/card-style-expanded.png)

6.  Klicka på **Preview Mode** högst upp för att se hur det skulle se ut i chatten.

    ![Preview](../../assets/standard/images/chap07/card-preview.png)
...
1.  Längst ner i fönstret ser du **Card Payload Editor**. (Dra upp kanten om den är liten).
    ...
    ![Payload Editor](../../assets/standard/images/chap07/card-payload-editor.png)
...
4.  Klicka på **Preview Mode** för att se ditt snygga kort!
    *Just nu är listan på datorer "Hårdkodad" (Surface Laptop 13, 15 etc). Det ska vi ändra på nu.*
    ...
    ![Preview](../../assets/standard/images/chap07/card-preview-static.png)
...
2.  Längst upp till höger i editor-fönstret (ovanför koden), klicka på **JSON** och ändra till **Formula**.
    ...
    ![Ändra till Formula](../../assets/standard/images/chap07/card-formula-mode.png)

3.  Klicka på **Expand**-ikonen (pilarna) för att göra formelfältet större.

    ![Expandera formel](../../assets/standard/images/chap07/card-formula-expand.png)
...
6.  Kontrollera att du har en **grön bock** nere i hörnet (inga syntaxfel).
    ...
    ![Grön bock](../../assets/standard/images/chap07/card-formula-check.png)
...
7.  Klicka på **Save card** (eller stäng krysset om knappen saknas, det sparas ofta automatiskt) och stäng sedan Adaptive Card-egenskaperna.
    ...
    ![Spara och stäng](../../assets/standard/images/chap07/card-save-close.png)
...
![Output variabler](../../assets/standard/images/chap07/topic-output-vars.png)
...
1.  Gå till fliken **Overview**.
    ...
    ![Overview](../../assets/standard/images/chap07/agent-overview.png)

2.  Vid **Instructions**, klicka på **Edit**.

    ![Edit instructions](../../assets/standard/images/chap07/agent-instructions-edit.png)
...
5.  Klicka **Save**.
    ...
    ![Save](../../assets/standard/images/chap07/agent-save.png)

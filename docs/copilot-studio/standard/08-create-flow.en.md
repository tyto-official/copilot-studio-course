...
4.  Välj **Add a tool** -> **New Agent flow**.
    *(Ibland kan det heta "Call an action" -> "Create a flow" beroende på version).*
    ...
    ![Skapa flöde](../../assets/standard/images/chap08/topic-call-action-flow.png)
...
1.  Klicka på noden **When an agent calls the flow** för att öppna inställningarna.
    ...
    ![Öppnar noden](../../assets/standard/images/chap08/flow-open-inputs.png)

2.  Klicka på **+ Add an input**.

    ![Add input](../../assets/standard/images/chap08/flow-add-input.png)

3.  Du ser nu ett gäng olika typer av inputs. Välj **Text**.

    ![Add input text](../../assets/standard/images/chap08/flow-add-input-text.png)
...
4.  Ställ dig i textrutan (där det står "User's input") och döp om den till:
    ...
    *Här skickar vi in ID:t från SharePoint.*
    ...
    ![Input DeviceSharePointId](../../assets/standard/images/chap08/flow-add-input-text-device.png)
...
5.  Gör om proceduren. Klicka **+ Add an input** -> **Text**. Döp den till:
    ...
    *Här skickar vi in användarens namn.*
    ...
    ![Input User](../../assets/standard/images/chap08/flow-add-input-text-user.png)
...
6.  Gör om proceduren igen. Klicka **+ Add an input** -> **Text**. Döp den till:
    ...
    ![Input AdditionalComments](../../assets/standard/images/chap08/flow-trigger-inputs-text-comments.png)
...
7.  **Gör kommentaren frivillig:**
    ...
    * Välj **Make the field optional**.
    ...
    ![Gör input frivillig](../../assets/standard/images/chap08/flow-input-optional.png)
...
2.  Sök efter **Get item** och välj **Get item (SharePoint)**.
    *(Obs: Välj "Get item" i singular, inte "Get items", eftersom vi bara ska hämta en specifik rad).*
    ...
    ![Get item action](../../assets/standard/images/chap08/flow-action-getitem.png)
...
3.  **Döp om steget (Best Practice):**
    ...
    * Döp den till:
    ...
    ![Rename step](../../assets/standard/images/chap08/flow-getitem-rename.png)

4.  **Konfigurera steget:**
    * **Site Address:** Välj din IT Support-sida.

    ![Site Address](../../assets/standard/images/chap08/flow-getitem-siteaddress.png)

    * **List Name:** Välj listan **Devices**.

    ![List Name](../../assets/standard/images/chap08/flow-getitem-listname.png)

    * **Id:** Vi måste koppla detta till vårt input-värde. Klicka på **fx** (eller blixten) längst till vänster i Id-rutan.

    ![Id fx](../../assets/standard/images/chap08/flow-getitem-id.png)

    * Välj **Dynamic content** och sök efter:
    ```text
    DeviceSharePointId
    ```
    ![Mappa ID](../../assets/standard/images/chap08/flow-getitem-dynamic.png)

    * Notera att syntaxen `triggerBody()?['text']` (eller liknande) används när du klickar på **DeviceSharePointId**. Klicka nu på **Add**.

    ![Add button](../../assets/standard/images/chap08/flow-getitem-add.png)

5.  **Avancerade inställningar:**
    * Klicka på **Show all** i inställningarna för *Get Device*.
    ![Show all](../../assets/standard/images/chap08/flow-getitem-showall.png)
    * Hitta **Limit Columns by View**.
    * Välj **All Items**.
    ![Limit Columns by View](../../assets/standard/images/chap08/flow-getitem-limitcolumns.png)
...
2.  Sök efter:
    ...
    Send an email
    ```
    ![Send an email](../../assets/standard/images/chap08/flow-action-email.png)
...
4.  **Konfigurera mejlet:**
    ...
    * **To:** Klicka på **Enter custom value** och skriv in **din egen e-postadress**.
    ...
    ![To field](../../assets/standard/images/chap08/flow-action-email-to.png)
    ...
    * **Subject:** Skriv följande text:
    ...
    ```
    ![Subject field](../../assets/standard/images/chap08/flow-action-email-subject.png)
    ...
    * **Body:** Här bygger vi meddelandet. Kopiera först in grundtexten nedan:
    ...
    ![Email body setup](../../assets/standard/images/chap08/flow-action-email.png)
    ...
    * Klicka på **blixt-ikonen** (Dynamic content) eller `fx`.
    ...
    ![Dynamic content icon](../../assets/standard/images/chap08/flow-email-dynamiccontent.png)
    ...
    * Sök efter `User` och välj den från listan (under "When an agent calls the flow").
    ...
    ![Select User](../../assets/standard/images/chap08/flow-email-select-user.png)
    ...
    * Sök efter `Model` (från steget *Get Device*) och välj den.
    ...
    ![Select Model](../../assets/standard/images/chap08/flow-email-select-model.png)
    ...
    * Sök efter `Price` (från steget *Get Device*) och välj den.
    ...
    ![Select Price](../../assets/standard/images/chap08/flow-email-select-price.png)
    ...
    * I rutan för Function/Expression, skriv in följande start:
    ...
    ![Select AdditionalComments](../../assets/standard/images/chap08/flow-email-select-additionalcomments.png)
    ...
    * Klicka nu på fliken **Dynamic content**. Sök efter `AdditionalComments` och klicka på den.
    ...
    ![Select AdditionalComments](../../assets/standard/images/chap08/flow-email-select-additionalcomments2.png)
    ...
    * Gå tillbaka till formelfältet och skriv in resten av logiken efter parentesen (efter första stängda parantesen):
    ...
    ![Select AdditionalComments](../../assets/standard/images/chap08/flow-email-select-additionalcomments3.png)
    ...
    * Klicka på **Add** (eller OK).
    ...
    ![Expression Logic](../../assets/standard/images/chap08/flow-email-expression-add.png)
...
2.  Klicka **+ Add an output**.
    ...
    ![Add Output](../../assets/standard/images/chap08/flow-output-add.png)

3.  Klicka på **Text**.

    ![Add Output Text](../../assets/standard/images/chap08/flow-output-add-text.png)
...
5.  I värdefältet, klicka på **blixt-ikonen** (Dynamic content) eller `fx`.
    ...
    ![Add Output Value](../../assets/standard/images/chap08/flow-output-modelvalue.png)
...
6.  Sök efter `Model` (från steget *Get Device*) och välj den.
    ...
    ![Select ModelValue](../../assets/standard/images/chap08/flow-output-select-modelvalue.png)
...
1.  Längst upp till vänster, klicka på namnet **Save draft**.
    ...
    ![Save draft](../../assets/standard/images/chap08/flow-save-draft.png)

2.  Klicka nu på **Overview** (till vänster om namnet).

    ![Overview](../../assets/standard/images/chap08/flow-overview.png)

3.  Väl inne i översikten, klicka på **Edit** under *Details*.

    ![Edit Details](../../assets/standard/images/chap08/flow-edit.png)
...
6.  Klicka på **Save**.
    ...
    ![Save Details](../../assets/standard/images/chap08/flow-save.png)
...
7.  Viktigt: För att flödet ska fungera måste det publiceras. Klicka på **Publish** i verktygsfältet (oftast uppe till vänster).
    *(Ibland måste du gå in i Designer-läget igen för att se Publish-knappen).*
    ...
    ![Publish Flow](../../assets/standard/images/chap08/flow-designer-publish.png)
...
1.  **Navigera till *Request device* Topicen:**
    * Gå tillbaka till Agent-vyn genom att klicka på **Agents** i menyn till vänster.
    ...
    ![Agents Menu](../../assets/standard/images/chap08/flow-agents.png)

    * Välj din agent **IT Support Helper**.

    ![IT Support Helper](../../assets/standard/images/chap08/flow-it-support-helper.png)

    * Gå till fliken **Topics** i menyn högst upp.

    ![Topics Tab](../../assets/standard/images/chap08/flow-topics.png)

    * Klicka på **Request device**.

    ![Request device Topic](../../assets/standard/images/chap08/flow-request-device.png)
...
2.  **Lägg till flödet:**
    ...
    * Välj ditt nyligen skapade flöde: **Send device request email**.
    ...
    ![Add Custom Flow](../../assets/standard/images/chap08/add-custom-flow.png)
...
3.  **Mappa inputs:**
    ...
    * Välj variabeln `deviceSelectionId` (den kommer från ditt Adaptive Card).
    ...
    ![Map Device ID](../../assets/standard/images/chap08/add-custom-flow-deviceid.png)
    ...
    * Sök efter och välj `User.DisplayName`.
    ...
    ![Map User](../../assets/standard/images/chap08/add-custom-flow-user.png)
    ...
    * Välj fliken **Formula** och klicka på expandera-ikonen (pilen) för att få mer plats.
    ...
    ![Map Comments](../../assets/standard/images/chap08/add-custom-flow-additionalcomments.png)
    ...
    * Kontrollera att du har en grön bock (inget syntaxfel). Klicka sedan på **Insert**.
    ...
    ![Insert Formula](../../assets/standard/images/chap08/add-custom-flow-additionalcomments2.png)
...
1.  Klicka på **plus-tecknet (+)** under din Agent Flow-nod och välj **Send a message**.
    ...
    ![Lägg till meddelande](../../assets/standard/images/chap08/topic-add-message-confirm.png)
...
2.  Vi ska nu bygga meddelandet steg för steg för att få in dynamiska värden:
    ...
    * Välj fliken **System** och sök efter `User`. Välj **User.DisplayName**.
    ...
    ![Infoga användarnamn](../../assets/standard/images/chap08/topic-msg-insert-user.png)
    ...
    *(Detta är variabeln vi fick tillbaka från vårt Agent Flow).*
    ...
    ![Infoga modell](../../assets/standard/images/chap08/topic-msg-insert-model.png)
...
3.  Granska meddelandet. Det ska nu se ut ungefär så här i editorn:
    ...
    ![Färdigt meddelande](../../assets/standard/images/chap08/topic-msg-complete.png)

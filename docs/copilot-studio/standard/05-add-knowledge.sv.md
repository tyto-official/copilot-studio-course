...
4. Klicka på namnet (där det står Dokument) i den översta namnlisten och döp filen till IT-Policy och Rutiner.
...
2. Leta upp sektionen **Kunskap** (oftast mitt på sidan eller under fliken Kunskap) och klicka på **Lägg till kunskap**.
    ...
    ![Meny för att lägga till kunskap](../../assets/standard/images-sv/chap05/1.png)

3. Välj OneDrive i fältet **Ladda upp fil** (eller *välj för att bläddra*).

    ![Välja filen](../../assets/standard/images-sv/chap05/2.png)

4. Leta upp filen `IT_Policy och Rutiner` som du nyss skapade och välj den genom att klicka på den och sedan klicka på **Bekräfta val**.

    ![Välja filen](../../assets/standard/images-sv/chap05/3.png)

5. Klicka på **Lägg till i agent**.

    ![Bekräfta uppladdning](../../assets/standard/images-sv/chap05/4.png)
...
1. Klicka på **+ Lägg till kunskap** igen.
2. Välj **Offentliga webbplatser**.

    ![Meny för att lägga till kunskap](../../assets/standard/images-sv/chap05/5.png)

3. I rutan för URL, klistra in:
    `https://support.microsoft.com/sv-se/windows` och klicka på **Lägg till**.

    ![Lägga till webbsida](../../assets/standard/images-sv/chap05/6.png)

4. Klicka där efter på **Lägg till i agent**.

    ![Bekräfta uppladdning](../../assets/standard/images-sv/chap05/7.png)
...
1. Gå till testchatten och klicka på **Starta ny session** högst upp för att starta om konversationen.

    ![Starta om testet](../../assets/standard/images-sv/chap05/8.png)
...
1.  Längst upp i testpanelen, klicka på ikonen för **Expandera testpanelen** (ser ut som en pil).
    ...
    ![Aktivera aktivitetskarta](../../assets/standard/images-sv/chap05/9.png)
...
3.  Nu ser du flödet som agenten gick igenom. Klicka på boxen som heter **Sök i källor** om du inte direkt ser den detaljerade rutan.
    ...
    ![Klicka på noden i kartan](../../assets/standard/images-sv/chap05/9,5.png)

4.  En detaljruta öppnas. Här ser du exakt vilka källor agenten har **utvärderat**.
    
    ![Detaljer om källan](../../assets/standard/images-sv/chap05/10.png)
...
1.  Klicka på **Starta ny session** högst upp i testpanelen för att rensa minnet.
    ...
    ![Starta om testet](../../assets/standard/images-sv/chap05/11.png)
...
!!! info "Alternativ: Webbsökning (Hela internet)"
    ...
    ![Webbsökningsinställning](../../assets/standard/images-sv/chap05/12.png)

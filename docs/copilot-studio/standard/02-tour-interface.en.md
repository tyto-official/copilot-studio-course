...
![Startsidan i Copilot Studio](../../assets/standard/images/chap02/tour-home-landing.png)

### Kontrollera miljön (Igen!)
Det första du **alltid** ska göra är att titta uppe i högra hörnet.

![Miljöväljaren uppe till höger](../../assets/standard/images/chap02/tour-env-selector.png)
...
![Agent](../../assets/standard/images/chap02/tour-toggle-agent.png) 
...
![Workflow](../../assets/standard/images/chap02/tour-toggle-workflow.png) 

Under chattrutan har du tre genvägar för att börja från noll (Start building from scratch):

![Create](../../assets/standard/images/chap02/tour-create-menu.png)
...
![Vänstermenyn](../../assets/standard/images/chap02/tour-left-menu.png)

### Agents (Agenter)
Klicka på **Agents** i menyn.

![Agenter](../../assets/standard/images/chap02/tour-agents.png)
...
![Flöden](../../assets/standard/images/chap02/tour-flows.png)
...
![Översikt av Tools-sidan](../../assets/standard/images/chap02/tour-tools-main.png)

Klicka på **+ New tool** för att se vad vi kan skapa.

![Menyn för att skapa nya tools](../../assets/standard/images/chap02/tour-tools-create-menu.png)
...
![Menyn More med fler alternativ](../../assets/standard/images/chap02/tour-more-menu.png)

...
2.  Klicka **+ Add trigger**.
    ...
    ![Add Trigger](../../assets/standard/images/chap10/bild1.png)
...
4.  Klicka på **When a new email arrives (V3)** och därefter på **Next**.
    ...
    ![Select Email Trigger](../../assets/standard/images/chap10/bild2.png)

5.  Kontrollera att anslutningen är grön (Connected) och klicka på **Next**.

    ![Check Connection](../../assets/standard/images/chap10/bild3.png)
...
6.  **Konfigurera triggern:**
    ...
    * **Folder:** Klicka på mapp-ikonen och välj **Inbox** (Inkorgen).
    ...
    ![Select Inbox](../../assets/standard/images/chap10/bild4.png)

    * **Importance:** Låt resterande vara oförändrade och klicka på **Create trigger**.

    ![Select Inbox](../../assets/standard/images/chap10/bild5.png)
...
1.  Stäng *Time to test your trigger!* vilket leder tillbaka till agentens **Overview**.
    ...
    ![No Test](../../assets/standard/images/chap10/bild6.png)

2.  Scrolla ner till **Agents** delen i **Overview** och klicka på **+ Add agent**.

    ![Add Agent](../../assets/standard/images/chap10/bild7.png)
...
3.  Rutan *Choose how you want to extend your agent* dyker upp.
    ...
    * Klicka på **New child agent**.
    ...
    ![New Child Agent](../../assets/standard/images/chap10/bild8.png)
    ...
    * Klicka sedan på **Save** uppe i högra hörnet.
    ...
    ![Save](../../assets/standard/images/chap10/bild9.png)
...
1.  Gå till delen **Tools** inne i din Child Agent och klicka på **+ Add**.
    ...
    ![Tools](../../assets/standard/images/chap10/bild10.png)

2.  Sök efter:
    ```text
    Post message in a chat or channel
    ```
    ![Search Tool](../../assets/standard/images/chap10/bild11.png)

3.  Välj **Post message in a chat or channel** genom att klicka på den.

    ![Add Teams Action](../../assets/standard/images/chap10/bild12.png)

4.  Kontrollera anslutningen och klicka **Add and configure**.

    ![Add Configure](../../assets/standard/images/chap10/bild13.png)
...
5.  **Konfigurera verktyget:**
    ...
    * **Description:**
    ...
    ![Configure Tool](../../assets/standard/images/chap10/bild15.png)
...
6.  **Konfigurera inputs:**
    ...
    8. I rutan **Description** för Message, skriv in följande:
       ...
       ```
    ![Message](../../assets/standard/images/chap10/bild23.png)
...
1.  Klicka på **<- Notify IT Team**.
    ...
    ![Notify IT Team](../../assets/standard/images/chap10/bild24.png)
...
2.  **Ge instruktioner:**
    ...
    * Ställ dig direkt efter ` /Notify IT Team ` och välj **Notify IT Team** verktyget genom att klicka på popupmenyn.
    ...
    ![Agent Instructions](../../assets/standard/images/chap10/bild25.png)

    * Klicka på **Save**.

    ![Save](../../assets/standard/images/chap10/bild14.png)
...
1.  Navigera tillbaka till huvudagentens **Overview**.
    ...
    ![Huvudagent Overview](../../assets/standard/images/chap10/bild26.png)

2.  Gå ner till **Instructions** och klicka på **Edit**.

    ![Huvudagent Instructions](../../assets/standard/images/chap10/bild27.png)
...
4.  Skapa länkningen (Viktigt):
    ...
    * Klicka på **Email Agent** i popupmenyn.
    ...
    ![Huvudagent Instructions Added](../../assets/standard/images/chap10/bild28.png)

5.  Klicka på **Save**.

    ![Huvudagent Instructions Added](../../assets/standard/images/chap10/bild29.png)

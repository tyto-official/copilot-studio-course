...
2. Leta upp sektionen **Knowledge** (oftast mitt på sidan eller under fliken Knowledge) och klicka på **Add knowledge**.
    ...
    ![Meny för att lägga till kunskap](../../assets/standard/images/chap05/knowledge-add.png)

3. Välj OneDrive i **Upload file** fältet (eller *select to browse*).

    ![Välja filen](../../assets/standard/images/chap05/knowledge-choose-onedrive.png)
...
4. Leta upp filen `IT_Policy och Rutiner` som du nyss skapade och välj den genom att klicka på den och sedan klicka på **Confirm selection**.
    ...
    ![Välja filen](../../assets/standard/images/chap05/knowledge-browse.png)

5. Klicka på **Add to agent**.

    ![Bekräfta uppladdning](../../assets/standard/images/chap05/knowledge-confirm-file.png)
...
2. Välj **Public websites**.
    ...
    ![Meny för att lägga till kunskap](../../assets/standard/images/chap05/knowledge-add-menu.png)

3. I rutan för URL, klistra in:
    `https://support.microsoft.com/sv-se/windows` och klicka på **Add**.

    ![Lägga till webbsida](../../assets/standard/images/chap05/knowledge-web-input.png)

4. Klicka där efter på **Add to agent**.

    ![Bekräfta uppladdning](../../assets/standard/images/chap05/knowledge-confirm-web.png)
...
1.  Längst upp i testpanelen, klicka på ikonen för **Expand test panel** (ser ut som en pil).
    ...
    ![Aktivera Activity Map](../../assets/standard/images/chap05/test-map-toggle.png)

2.  Nu ser du flödet som agenten gick igenom. Klicka på boxen som heter **Search sources**.

    ![Klicka på noden i kartan](../../assets/standard/images/chap05/test-map-node.png)

3.  En detaljruta öppnas. Här ser du exakt vilka källor agenten har **utvärderat**.
    
    ![Detaljer om källan](../../assets/standard/images/chap05/test-map-details.png)
    ...
    * Men eftersom svaret bara fanns i dokumentet, var det bara den källan som användes för att formulera svaret (Referenced).
    ...
    ![Refererad källa](../../assets/standard/images/chap05/referenced-source.png)
...
1.  Klicka på **New test session** högst upp i testpanelen för att rensa minnet.
    ...
    ![Starta om testet](../../assets/standard/images/chap05/test-reset.png)
...
![Förväntat resultat](../../assets/standard/images/chap05/test-expected-result.png)
...
!!! info "Alternativ: Web Search (Hela internet)"
    ...
    ![Web Search inställning](../../assets/standard/images/chap05/web-search-toggle.png)

...
1.  Gå till fliken **Topics** i menyn.
    ...
    ![Topics](../../assets/standard/images/chap06/topic-menu.png)

2.  Klicka på **+ Add a topic** och välj **From blank**.

    ![Skapa topic från blankt](../../assets/standard/images/chap06/topic-create-blank.png)
...
3.  Nu ser du en tom topic. Klicka på namnet "Untitled" högst upp till vänster och döp den till:
    ...
    ![Döp topic till Available devices](../../assets/standard/images/chap06/topic-rename.png)
...
4.  Redan nu på arbetsytan (Canvasen) ser du rutan **Trigger**. Under rubriken *Describe what the topic does*, klistra in följande beskrivning:
    ...
    *Beskrivningen är avgörande. Det är den här texten som agentens "hjärna" läser för att förstå NÄR den ska aktivera just den här topicen.*
    ...
    ![Topic Description i Trigger-noden](../../assets/standard/images/chap06/topic-trigger-description.png)
...
1.  Klicka på **Details** (cirkeln med utropstecken `i`) längst upp till höger för att fälla ut detaljpanelen.
    *Notera att Name och Description redan är ifyllda eftersom vi gjorde det i förra steget.*
    ...
    ![Verifiera detaljer](../../assets/standard/images/chap06/topic-details-verify.png)

2.  I detaljpanelen, klicka på fliken **Input**.

    ![Topic Input](../../assets/standard/images/chap06/topic-input.png)

3.  Klicka på knappen **Create a new variable**.

    ![Skapa input variabel](../../assets/standard/images/chap06/topic-input-create.png)
...
5.  **Identify as:** Klicka på listan och välj: **User's entire response**.
    *Detta ger oss mest flexibilitet att fånga upp precis det användaren frågar efter.*
    ...
    ![Välja Identify as](../../assets/standard/images/chap06/topic-identify-as.png)
...
6.  **Description:** (Detta fält är till för AI:n, inte användaren).
    ...
    ![Variabelinställningar klara](../../assets/standard/images/chap06/topic-variable-settings.png)
...
1.  Längst upp i detaljpanelen, klicka på fliken **Output**.
    ...
    ![Topic Output flik](../../assets/standard/images/chap06/topic-output.png)

2.  Klicka på **Create a new variable**.

    ![Skapa output variabel](../../assets/standard/images/chap06/topic-output-create.png)
...
3.  **Description:**
    ...
    ![Output inställningar](../../assets/standard/images/chap06/topic-output-settings.png)

4.  Nu är vi klara med inställningarna! Stäng detaljpanelen genom att klicka på krysset (**X**) högst upp till höger.

    ![Stäng panelen](../../assets/standard/images/chap06/topic-details-close.png)
...
1.  Håll muspekaren över linjen under din **Trigger**-nod och klicka på **plus-tecknet (+)**.
    ...
    ![Lägg till nod](../../assets/standard/images/chap06/topic-add-node.png)

2.  En meny öppnas. Här är en snabb genomgång av verktygslådan:

    ![Verktygslådan](../../assets/standard/images/chap06/topic-toolbox.png)
...
3.  Välj **Add a condition**.
    ...
    ![Add a condition](../../assets/standard/images/chap06/topic-add-condition.png)
...
1.  Klicka på rutan där det står **Condition** och döp noden till: 
    ...
    ![Condition](../../assets/standard/images/chap06/topic-laptop-condition.png)
...
5.  I rutan *Enter or select a value*, skriv:
    ...
    *Nu har du sagt: "Om användaren letar efter en Laptop -> Gå till vänster. Annars -> Gå till höger."*
    ...
    ![Vägvalet klart](../../assets/standard/images/chap06/topic-condition-split-laptop.png)
...
2.  Välj **Ask a question**.
    ...
    ![Välj fråga](../../assets/standard/images/chap06/topic-question-performance.png)
...
3.  **Döp om noden:**
    ...
    ![Döp om noden](../../assets/standard/images/chap06/topic-question-performance-rename.png)
...
4.  I rutan **Enter a message**, skriv:
    ...
    ![Fråga meddelande](../../assets/standard/images/chap06/topic-question-performance-message.png)
...
6.  Under **Options for user**, skapa två alternativ:
    ...
    *(Genom att ge specifika alternativ styr vi användaren rätt).*
    ...
    ![Alternativ för prestanda](../../assets/standard/images/chap06/topic-question-performance-options.png)
...
1.  Klicka på rutan där det står **Save user response as** (där namnet `Var1` står).
    ...
    ![Döp om variabel](../../assets/standard/images/chap06/topic-var-rename-performance.png)
...
2.  En ruta öppnas till höger. Ändra **Name** till:
    ...
    ![Döp om variabel](../../assets/standard/images/chap06/topic-var-rename-performance-2.png)
...
![Grenar](../../assets/standard/images/chap06/topic-branches.png)
...
2.  Klicka på de **tre prickarna (...)** på den noden och välj **Delete**.
    *Nu har du bara två vägar kvar: Standard och All other conditions.*
    ...
    ![Grenar](../../assets/standard/images/chap06/topic-branches-delete.png)
...
2.  Välj **Send a message**.
    ...
    ![Meddelande](../../assets/standard/images/chap06/topic-message-outofstock.png)
...
3.  Skriv:
    ...
    ![Meddelande om slut i lager](../../assets/standard/images/chap06/topic-message-outofstock-2.png)
...
2.  Klicka på **plus-tecknet (+)** under sammanslagningen (där trådarna möts).
    ...
    ![Lägg till action](../../assets/standard/images/chap06/topic-ja-add-node.png)

3.  Välj **Add a tool**

    ![Lägg till action](../../assets/standard/images/chap06/topic-action-add-tool.png)

4.  Välj **Connectors**

    ![Lägg till action](../../assets/standard/images/chap06/topic-action-add-tool-connectors.png)
...
5.  Sök efter **SharePoint - Get items**
    ...
    ![Lägg till action](../../assets/standard/images/chap06/topic-action-add-tool-sharepoint-getitems.png)
...
![Connector tillagd](../../assets/standard/images/chap06/topic-connector-submit.png)
...
1.  Klicka på de **tre prickarna (...)** i högra hörnet på den nya *Get items*-noden och välj **Properties**.
    ...
    ![Tre prickar](../../assets/standard/images/chap06/topic-connector-properties-node.png)
...
3.  I fältet **Usage Description**, skriv:
    ...
    *(Detta hjälper agenten förstå vad verktyget gör).*
    ...
    ![Properties panel](../../assets/standard/images/chap06/topic-properties-pane.png)

4.  Hoppa över "Error handling". Gå direkt till sektionen **Inputs**.

    ![Inputs](../../assets/standard/images/chap06/topic-prop-inputs.png)

5.  **Site Address:** Välj din SharePoint-sida (**IT Support**) i listan.

    ![Välj site](../../assets/standard/images/chap06/topic-prop-site.png)

6.  **List Name:** Välj din lista (**Devices**).

    ![Välj lista](../../assets/standard/images/chap06/topic-prop-list.png)
...
1.  Hitta fältet **Filter Query** under *Advanced parameters*.
    ...
    ![Filter query](../../assets/standard/images/chap06/topic-prop-filterquery.png)

2.  Klicka på de **tre prickarna (...)** vid fältet och välj **Formula**.

    ![Tre prickar](../../assets/standard/images/chap06/topic-prop-filterquery-formula.png)

3.  Klicka på den lilla pilen (vinkeln) för att expandera formelfältet så du ser bättre.

    ![Expandera formel](../../assets/standard/images/chap06/topic-prop-formula-expand.png)
...
5.  Kontrollera att du har en liten **grön bock** brevid formelfältet. Det betyder att koden är korrekt.
    ...
    ![Grön bock formel](../../assets/standard/images/chap06/topic-prop-formula-check.png)
...
7.  (Valfritt men bra) Scrolla ner till **Limit Columns by View**. Välj **All items**.
    *Ibland kan SharePoint gömma kolumner om man inte väljer en vy. Detta garanterar att vi får all data. Kan behöva refresch för att få upp alternativen.*
    ...
    ![Välj vy](../../assets/standard/images/chap06/topic-prop-view.png)
...
1.  I Properties-panelen, klicka på fliken **Output**.
    ...
    ![Output flik](../../assets/standard/images/chap06/topic-prop-output.png)
...
3.  Döp om den till:
    ...
    ![Output inställningar](../../assets/standard/images/chap06/topic-prop-output-vardevices.png)
...
4.  Ändra **Usage** till **Global**.
    *Varför? För att vi vill att denna lista ska vara tillgänglig för hela agenten, ifall vi vill använda den i andra topics senare.*
    ...
    ![Output inställningar](../../assets/standard/images/chap06/topic-prop-output-global.png)
...
2.  Välj **Variable management** -> **Set a variable value**.
    ...
    ![Set variable](../../assets/standard/images/chap06/topic-set-var-node.png)

3.  Under **Set variable**, välj topicens output-variabel: `VarAvailableDevices`.

    ![Set variable](../../assets/standard/images/chap06/topic-set-var-node-varavailabledevices.png)

4.  Under **To value**, klicka på pilen/ikonen och välj **Formula**.

    ![Set variable](../../assets/standard/images/chap06/topic-set-var-node-value-to-formula.png)
...
5.  Skriv in följande formel:
    ...
    **Varför .value?**
    ...
    ![Formel för value](../../assets/standard/images/chap06/topic-set-var-formula-value.png)
...
1.  Gå till fliken **Overview** högst upp.
    ...
    ![Overview flik](../../assets/standard/images/chap06/agent-overview.png)

2.  Vid **Instructions**, klicka på **Edit**.

    ![Edit instructions](../../assets/standard/images/chap06/agent-instructions-edit.png)

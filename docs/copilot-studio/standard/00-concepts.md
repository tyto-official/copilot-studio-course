...
![Hur snabbt ChatGPT slog igenom](../../assets/standard/images/chap/hit-100m-users.jpg)
...
![Tidigare bildmodeller gav ofta sämre och mindre realistiska resultat](../../assets/standard/images/chap/fore.jpg)

![Nyare bildmodeller ger ofta betydligt mer realistiska och detaljerade resultat](../../assets/standard/images/chap/efter.png)
...
![Exempel på rapporterade uppgifter om träningsdata](../../assets/standard/images/chap/youtube.png)
...
![Hur en språkmodell tränas](../../assets/standard/images/chap/training-loop.svg)
...
![Förenklad intuition för vad en vikt gör](../../assets/standard/images/chap/weight-equation.svg)
...
![Början av träningen: bilarna kör åt alla håll](../../assets/standard/images/chap/bil1.jpg)

![Tidigt i träningen: några bilar börjar hitta rätt](../../assets/standard/images/chap/bil2.jpg)

![Senare i träningen: fler bilar klarar svängen](../../assets/standard/images/chap/bil3.jpg)

![Slutet av träningen: bilarna klarar banan](../../assets/standard/images/chap/bil4.jpg)

</div>

*Bilanalogin visualiserad: från många fel i början till en modell som gradvis lär sig köra bättre.*

![Efter träningen: modellen används i nya situationer](../../assets/standard/images/chap/bil5.png)
...
![Hur en språkmodell bygger upp ett svar](../../assets/standard/images/chap/inference-loop.svg)
...
![Nvidias börsutveckling i takt med ökat AI-intresse](../../assets/standard/images/chap/nvidia-stock.png)
...
![Exempel på modellfamiljer](../../assets/standard/images/chap/valjmodell.png)
...
![Lokal modell i Ollama](../../assets/standard/images/chap/ollama-ministral-3b.png)
...
![Exempel på kostnader för kraftiga Nvidia-GPU:er](../../assets/standard/images/chap/gpu-price.png)
...
![Ranking av stora closed source-modeller](../../assets/standard/images/chap/ranking.png)
...
![Tokens som textdelar](../../assets/standard/images/chap/1.png)
...
![Token-ID:n](../../assets/standard/images/chap/token-id.png)
...
![Text, tokens och bitar](../../assets/standard/images/chap/token-representation.svg)
...
![Resonerande modeller anvander ocksa en del av budgeten](../../assets/standard/images/chap/resoning.png)
...
![Window](../../assets/standard/images/chap/7.jpeg)
...
2. Vi delar upp den i små stycken (**chunks**).
   ...
   ![Chunks](../../assets/standard/images/chap/2.png)
3. Sedan använder vi en särskild AI-modell som kallas för en **embeddingsmodell**. Dess uppgift är att läsa varje stycke, förstå betydelsen i det och skapa en **vektorrepresentation** av den betydelsen.
   ...
   ![Vector](../../assets/standard/images/chap/3.jpeg)
...
8. Först då skriver språkmodellen sitt svar, men nu med hjälp av relevant underlag från dokumenten.
   ...
   ![Hitta](../../assets/standard/images/chap/4.jpeg)
...
![Verktyg](../../assets/standard/images/chap/verktyg.png)
...
* **Workflow:** Ett styrt flöde där språkmodeller och verktyg används i vissa steg, men där den övergripande processen fortfarande är förutbestämd.
  ...
  ![Workflows](../../assets/standard/images/chap/5.jpeg)
* **Agent:** Ett system där språkmodellen i högre grad själv avgör vilka verktyg som ska användas, i vilken ordning och hur uppgiften ska lösas.
  ...
  ![Agent](../../assets/standard/images/chap/6.jpeg)

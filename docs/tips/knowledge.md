...
![Kunskapskällor i Copilot Studio](../assets/tips-trix/kunskap-pa-djupet/1.png)
...
1.  Klicka på **Verktyg** i menyn och sedan på **+ Lägg till**.
    ...
    ![Lägg till verktyg](../assets/tips-trix/kunskap-pa-djupet/2.png)

2.  Välj **Agentflöden** för att skapa ett nytt agentflöde.

    ![Välj agentflöden](../assets/tips-trix/kunskap-pa-djupet/3.png)

2.  Du ser två noder:
    - **När en agent anropar flödet** (Indata)
    - **Respond to the agent** (Utdata)

    ![Två noder](../assets/tips-trix/kunskap-pa-djupet/3.png)
...
1.  Klicka på **plus-tecknet (+)** mellan de två noderna.
    ...
    ![Plus-tecknet](../assets/tips-trix/kunskap-pa-djupet/4.png)

2.  Sök efter **Hämta filinnehåll** – välj SharePoint- eller OneDrive-varianten beroende på var din fil ligger.

    ![Sök hämta filinnehåll](../assets/tips-trix/kunskap-pa-djupet/5.png)
...
3.  Konfigurera noden:
    ...
    ![Välj fil](../assets/tips-trix/kunskap-pa-djupet/6.png)

#### 3. Konfigurera utdata

1.  Klicka på noden **Respond to the agent**.

    ![Respond to the agent](../assets/tips-trix/kunskap-pa-djupet/7.png)

2.  Klicka **+ Lägg till utdata** → **Text**.

    ![Lägg till utdata](../assets/tips-trix/kunskap-pa-djupet/8.png)

3.  Döp utdatan till ett passande namn, t.ex. `innehåll`.
4.  Klicka på **fx**-symbolen (Infoga uttryck).

    ![FX-symbolen](../assets/tips-trix/kunskap-pa-djupet/9.png)
...
6.  Klicka **Lägg till**.
    ...
    ![Uttryck för filinnehåll](../assets/tips-trix/kunskap-pa-djupet/10.png)

#### 4. Spara och publicera

1.  Klicka **Spara utkast**.

    ![Spara utkast](../assets/tips-trix/kunskap-pa-djupet/12.png)

2.  Klicka på **Översikt** (till vänster om flödesnamnet).

    ![Översikt](../assets/tips-trix/kunskap-pa-djupet/13.png)

3.  Klicka **Redigera** under *Detaljer*.

    ![Redigera](../assets/tips-trix/kunskap-pa-djupet/14.png)
...
6.  Klicka **Spara**.
    ...
    ![Spara detaljer](../assets/tips-trix/kunskap-pa-djupet/15.png)

7.  Gå tillbaka till **Designer** och klicka på **Publicera**.

    ![Designer](../assets/tips-trix/kunskap-pa-djupet/16.png)

    ![Publicera](../assets/tips-trix/kunskap-pa-djupet/17.png)

8.  Om allt fungerar får du en grön bekräftelseruta.

    ![Grön bekräftelse](../assets/tips-trix/kunskap-pa-djupet/18.png)
...
2.  Klicka på **Lägg till ett verktyg** → **Agentflöden**.
    ...
    ![Lägg till verktyg](../assets/tips-trix/kunskap-pa-djupet/19.png)

    ![Välj flöde](../assets/tips-trix/kunskap-pa-djupet/20.png)

3.  Välj ditt nyligen skapade flöde (**Produktinformation**).

    ![Välj flöde](../assets/tips-trix/kunskap-pa-djupet/21.png)

4.  Klicka **Lägg till och konfigurera**.

    ![Lägg till och konfigurera](../assets/tips-trix/kunskap-pa-djupet/22.png)
...
5.  Kontrollera att **namn** och **beskrivning** stämmer:
    ...
    ![Konfigurera verktyg](../assets/tips-trix/kunskap-pa-djupet/23.png)
...
3.  Lägg till:
    ...
    *(Kom ihåg att välja verktyget från popupmenyn så att det blir en aktiv länk.)*
    ...
    ![Instruktioner](../assets/tips-trix/kunskap-pa-djupet/24.png)
